...
int main()
{
    ...
    */
    ...
    if (inFile.is_open())
    {
        ...
        {
            plainTextString = plainTextString + temp;
        }
        inFile.close();
    }
    else
...
void keySchedule(unsigned char key[4][4], unsigned char roundKey[4][4][11])
{
    ...
    while (round < 10)
    {
        ...
        /*
            Add debugging here to see each round, need function to print the 2d array in round i
        */
...
void SubWord(unsigned char temp[4], int round)
{
    ...
    /*
        Apply the sBox to each element
    */
    for (int x = 0; x < 4; x++)
    {
        temp[x] = sBox[temp[x]];
...
void Rcon(unsigned char temp[4], int round)
{
    ...
    /*
        Apply the round constant to first element (0,3)
    */
...
void InvSubByte(unsigned char plainText[4][4])
{
    ...
    for (int y = 0; y < 4; y++)
    {
        for (int x = 0; x < 4; x++)
        {
            plainText[x][y] = InvsBox[plainText[x][y]];
        }
    }
